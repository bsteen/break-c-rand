...
# Given a sequence of 93 sequential numbers generated by glibc's rand function, this program should be able to correctly generate the next 93 (or more)
...
# However, for 13 of those runs, the program had to ask for extra numbers from c rand before it could break the sequence (i.e. needed more than 93 sequential numbers to break)
# In these cases, the average number of extra numbers past 93 needed was 2.93 (This makes sense, as 3 more values lets us better find the last n-3 terms in the sequence)
...
# TO DO: Make sure len(theinput) >= 93; Remove unnessary None checks
